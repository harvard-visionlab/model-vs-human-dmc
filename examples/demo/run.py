...
from modelvshuman_dmc import Plot, Evaluate, Analyze
...
def analysis():
    subjects = ["humans", "alexnet", "resnet50", "bagnet33", "simclr_resnet50x1", "vit_b_16", "convnext_large"]    
    subjects = ["humans", "alexnet"]
    datasets = c.DEFAULT_DATASETS
    
    Analyze()(subjects, datasets)
