...
% Edit this path to compile different reports:
% run: pdflatex report_test.tex
% \graphicspath{{../figures/plotting_definition_run05_vits/}}
% \graphicspath{{../figures/plotting_definition_robust_alexnets/}}
% \graphicspath{{../figures/plotting_definition_alexnets_simclr_hn/}}
\graphicspath{{../figures/plotting_definition_simclr_hn/}}
